        ...
        RESOVLER = true,
        Tracer = true,
        TracerColor = Color3.new(139, 0, 0),
...
--[[
 ...
 local AnchorCount = 0
    ...
    function noob(player)
        ...
        local handler = makemarker(guimain, player.Character:WaitForChild(SelectedPart), Color3.fromRGB(139, 0, 0), 0.3, 3)
    ...
    spawn(function()
        ...
        makemarker(placemarker, placemarker, Color3.fromRGB(139,0,0), 0.80, 0)
        end
    end)
        ...
        if k == Settings.Kalslock.Key and Settings.Kalslock.Enabled then
            if enabled == true then
                ...
                game.StarterGui:SetCore("SendNotification", {
                    Title = "Bloodseek";
                    Text = "  Unlocked",
                    Icon = "http://www.roblox.com/asset/?id=13247795016",
                    Duration = 3
                })
            end
            else
